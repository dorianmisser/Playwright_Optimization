/** Generated from: src\features\TC24_PostToSearchProductWithoutSearchParam.feature */
...
test.use({
  $test: ({}, use) => use(test),
  $uri: ({}, use) => use("src\\features\\TC24_PostToSearchProductWithoutSearchParam.feature"),
