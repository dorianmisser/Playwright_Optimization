/** Generated from: src\features\TC32_DeleteUserAccount.feature */
import { test } from "../../../src/fixtures/fixtures.ts";

test.describe("API Products", () => {

  test("API 14: DELETE METHOD To Delete User Account", { tag: ["@api"] }, async ({ When, apiUtils, Then, And }) => {
...
test.use({
  $test: ({}, use) => use(test),
  $uri: ({}, use) => use("src\\features\\TC32_DeleteUserAccount.feature"),
  $bddFileMeta: ({}, use) => use(bddFileMeta),
});

const bddFileMeta = {
  "API 14: DELETE METHOD To Delete User Account": {"pickleLocation":"3:5","tags":["@api"]},
};