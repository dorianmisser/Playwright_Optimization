/** Generated from: src\features\webFeatures\TC11_VerificationQuantitePanier.feature */
...
test.use({
  $test: ({}, use) => use(test),
  $uri: ({}, use) => use("src\\features\\webFeatures\\TC11_VerificationQuantitePanier.feature"),
