/** Generated from: src\features\apiFeatures\TC25_PostToVerifyLoginWithValidDetails.feature */
...
test.use({
  $test: ({}, use) => use(test),
  $uri: ({}, use) => use("src\\features\\apiFeatures\\TC25_PostToVerifyLoginWithValidDetails.feature"),
