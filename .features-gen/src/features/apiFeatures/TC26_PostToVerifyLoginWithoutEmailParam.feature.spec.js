/** Generated from: src\features\apiFeatures\TC26_PostToVerifyLoginWithoutEmailParam.feature */
...
test.use({
  $test: ({}, use) => use(test),
  $uri: ({}, use) => use("src\\features\\apiFeatures\\TC26_PostToVerifyLoginWithoutEmailParam.feature"),
